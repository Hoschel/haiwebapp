...
const PromptInput = ({onSubmit, loading = false, placeholder="Describe your idea...", large=false, autoFocus=false, variant="default"}) => {
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl w-full bg-white/10 backdrop-blur-xl rounded-xl ring-1 ring-white/25 focus-within:ring-2 focus-within:ring-white/30 overflow-hidden mt-6 transition">
            ...
            <div className='flex items-center justify-between pb-3 px-3 gap-2'>
                ...
                <div className='flex items-center justify-end gap-2'>
                    ...
                    <button type='submit' disabled={!value.trim() || loading} className='flex items-center justify-center p-1.5 rounded-full bg-red-600 text-white hover:bg-red-700 disabled:opacity-40 cursor-pointer'>

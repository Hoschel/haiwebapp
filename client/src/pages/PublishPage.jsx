  ...
  if(error || !project){
    return (
      <div className='h-screen w-screen flex flex-col items-center justify-center bg-zinc-50 px-4 text-center'>
        ...
        <p className='text-sm text-zinc-500 max-w-sm leading-relaxedd mb-6'>{error}</p>
        <div className='text-[10px] font-semibold uppercase tracking-widest text-zinc-400'>HoschelAI</div>
      </div>
    )
  }
